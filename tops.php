...
<div class="navbar" id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="tops.php" id="category">Tops</a>
...
<div class="clothing-display">
	<div class="row-clothing">
	  <div class="column-clothing">
		...
		<!-- form action -->
			<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
				  <img src="img/Top/top1.jpg" alt="top1" style="width:100%;display:block;" id="firstpic1" onmouseover="display(1)" onmouseleave="hide()">
				  <img src="img/Top/top1-1.jpg" alt="top2" style="width:100%;display:none;" id="secondpic1" onmouseover="display(1)" onmouseleave="hide()">
				  <p id="item1Name">Double Strap V Neck Chiffon Camisole</p>
				  <p id="item1Price"><b>S$15.99</b></p>
				  ...
				  <tr>
					...
					<button type="submit" class="shopping-button" name="buy" value="<?php echo '9' ?>"><i class="fa fa-shopping-cart" style="font-size:24px; color:black;" onclick="addToCart(itemNo,size)"></i></button></td>
				  </tr>
				  </table>
			</form>
		<!-- end form-->
	  ...
	  <div class="column-clothing">
		...
		<!-- form action -->
			<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
				  <img src="img/Top/top2.jpg" alt="top2" style="width:100%;display:block;" id="firstpic2" onmouseover="display(2)" onmouseleave="hide()">
				  <img src="img/Top/top2-1.jpg" alt="top2" style="width:100%;display:none;" id="secondpic2" onmouseover="display(2)" onmouseleave="hide()">
				  <p id="item2Name">Round Neck Halter Crop Top</p>
				  <p id="item2Price"><b>S$15.99</b></p>
				  <table border="0" style="margin:auto">		  
				  <tr>
					<td><p style="display:inline-block">Size:</p></td>
				  ...
				  <tr>
					...
					<input type="button" class="button2" value="+" onclick="qty(itemNo,size,'plus')">
					<button type="submit" class="shopping-button" name="buy" value="<?php echo '10' ?>"><i class="fa fa-shopping-cart" style="font-size:24px; color:black;" onclick="addToCart(itemNo,size)"></i></button></td>
				  </tr>
				  </table>
			</form>
		<!-- end form -->
	  ...
	  <div class="column-clothing">
		...
		<!-- form action -->
			<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
				  <img src="img/Top/top3.jpg" alt="top3" style="width:100%;display:block;" id="firstpic3" onmouseover="display(3)" onmouseleave="hide()">
				  <img src="img/Top/top3-1.jpg" alt="top3" style="width:100%;display:none;" id="secondpic3" onmouseover="display(3)" onmouseleave="hide()">
				  <p id="item3Name">Off Shoulder Droop Top</p>
				  <p id="item3Price"><b>S$19.99</b></p>
				  <table border="0" style="margin:auto">		  
				  <tr>
					<td><p style="display:inline-block">Size:</p></td>
				  ...
				  <tr>
					...
					<input type="button" class="button2" value="+" onclick="qty(itemNo,size,'plus')">
					<button type="submit" class="shopping-button" name="buy" value="<?php echo '11' ?>"><i class="fa fa-shopping-cart" style="font-size:24px; color:black;" onclick="addToCart(itemNo,size)"></i></button></td>
				  </tr>
				  </table>
			</form>
		<!-- end form -->
	...
	<div class="row-clothing">
	  <div class="column-clothing">
		...
		<!-- form action -->
			<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
				  <img src="img/Top/top4.jpg" alt="top4" style="width:100%;display:block;" id="firstpic4" onmouseover="display(4)" onmouseleave="hide()">
				  <img src="img/Top/top4-1.jpg" alt="top4" style="width:100%;display:none;" id="secondpic4" onmouseover="display(4)" onmouseleave="hide()">
				  <p id="item4Name">Double Layer Ruffle Halter Top</p>
				  <p id="item4Price"><b>S$23.99</b></p>
				  <table border="0" style="margin:auto">		  
				  <tr>
					<td><p style="display:inline-block">Size:</p></td>
				  ...
				  <tr>
					...
					<input type="button" class="button2" value="+" onclick="qty(itemNo,size,'plus')">
					<button type="submit" class="shopping-button" name="buy" value="<?php echo '12' ?>"><i class="fa fa-shopping-cart" style="font-size:24px; color:black;" onclick="addToCart(itemNo,size)"></i></button></td>
				  </tr>
				  </table>
			</form>
		<!-- end form -->
	  ...
	  <div class="column-clothing">
		...
		<!-- form action -->
			<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
				  <img src="img/Top/top5.jpg" alt="top5" style="width:100%;display:block;" id="firstpic5" onmouseover="display(5)" onmouseleave="hide()">
				  <img src="img/Top/top5-1.jpg" alt="top5" style="width:100%;display:none;" id="secondpic5" onmouseover="display(5)" onmouseleave="hide()">
				  <p id="item5Name">V-NECK LACE JACQUARD SHORT SLEEVE TOP</p>
				  ...
				  <tr>
					...
					<input type="button" class="button2" value="+" onclick="qty(itemNo,size,'plus')">
					<button type="submit" class="shopping-button" name="buy" value="<?php echo '13' ?>"><i class="fa fa-shopping-cart" style="font-size:24px; color:black;" onclick="addToCart(itemNo,size)"></i></button></td>
				  </tr>
				  </table>
			</form>
		<!-- end form -->
	  ...
	  <div class="column-clothing">
		...
		<!-- form action -->
			<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
				  <img src="img/Top/top6.jpg" alt="top6" style="width:100%;display:block;" id="firstpic6" onmouseover="display(6)" onmouseleave="hide()">
				  <img src="img/Top/top6-1.jpg" alt="top6" style="width:100%;display:none;" id="secondpic6" onmouseover="display(6)" onmouseleave="hide()">
				<p id="item6Name">Thick Strap Loose Top</p>
				<p id="item6Price"><b>S$25.99</b></p>
				  ...
				  <tr>
					...
					<input type="button" class="button2" value="+" onclick="qty(itemNo,size,'plus')">
					<button type="submit" class="shopping-button"  name="buy" value="<?php echo '14' ?>"><i class="fa fa-shopping-cart" style="font-size:24px; color:black;" onclick="addToCart(itemNo,size)"></i></button></td>
				  </tr>
				  </table>
			</form>
		<!-- end form -->
	...
	<div class="row-clothing">
	  <div class="column-clothing">
		...
		<!-- form action -->
			<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
				  <img src="img/Top/top7.jpg" alt="top7" style="width:100%;display:block;" id="firstpic7" onmouseover="display(7)" onmouseleave="hide()">
				  <img src="img/Top/top7-1.jpg" alt="top7" style="width:100%;display:none;" id="secondpic7" onmouseover="display(7)" onmouseleave="hide()">
				<p id="item7Name">Thin strap knitted camisole</p>
				<p id="item7Price"><b>S$27.99</b></p>
				  <table border="0" style="margin:auto">		  
				  <tr>
					<td><p style="display:inline-block">Size:</p></td>
				  ...
				  <tr>
					...
					<input type="button" class="button2" value="+" onclick="qty(itemNo,size,'plus')">
					<button type="submit" class="shopping-button" name="buy" value="<?php echo '15' ?>"><i class="fa fa-shopping-cart" style="font-size:24px; color:black;" onclick="addToCart(itemNo,size)"></i></button></td>
				  </tr>
				  </table>
			</form>
		<!-- end form -->
	  ...
	  <div class="column-clothing">
		...
		<!-- form action -->
			<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
				  <img src="img/Top/top8.jpg" alt="top8" style="width:100%;display:block;" id="firstpic8" onmouseover="display(8)" onmouseleave="hide()">
				  <img src="img/Top/top8-1.jpg" alt="top8" style="width:100%;display:none;" id="secondpic8" onmouseover="display(8)" onmouseleave="hide()">
				<p id="item8Name">V-NECK LACE BACK STRAP WITH CHIFFON TOP</p>
				<p id="item8Price"><b>S$19.99</b></p>
				  <table border="0" style="margin:auto">		  
				  <tr>
					<td><p style="display:inline-block">Size:</p></td>
				  ...
				  <tr>
					...
					<input type="button" class="button2" value="+" onclick="qty(itemNo,size,'plus')">
					<button type="submit" class="shopping-button" name="buy" value="<?php echo '16' ?>><i class="fa fa-shopping-cart" style="font-size:24px; color:black;" onclick="addToCart(itemNo,size)"></i></button></td>
				  </tr>
				  </table>
			</form>
		<!-- end form -->
	  ...
	  <div class="column-clothing">
		...
		<!-- form action -->
			<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
				  <img src="img/Top/top9.jpg" alt="top9" style="width:100%;display:block;" id="firstpic9" onmouseover="display(9)" onmouseleave="hide()">
				  <img src="img/Top/top9-1.jpg" alt="top9" style="width:100%;display:none;" id="secondpic9" onmouseover="display(9)" onmouseleave="hide()">
				<p id="item9Name">FRONT KNOT CROP TOP</p>
				<p id="item9Price"><b>S$19.99</b></p>
				  <table border="0" style="margin:auto">		  
				  <tr>
					<td><p style="display:inline-block">Size:</p></td>
				  ...
				  <tr>
					...
					<input type="button" class="button2" value="+" onclick="qty(itemNo,size,'plus')">
					<button type="submit" class="shopping-button" name="buy" value="<?php echo '17' ?>><i class="fa fa-shopping-cart" style="font-size:24px; color:black;" onclick="addToCart(itemNo,size)"></i></button></td>
				  </tr>
				  </table>
			</form>
		<!-- end form -->
